...
const ENTRIES = [
  {
    ...
    decisions: [
      ...
      '對稿改用「掃顏色邊界」:兩張 2× 圖同一欄由上而下列出顏色類別變化列、逐列相減。發現 Figma 匯出圖的卡頂在 y=1(陰影外溢只有 1px,不是 4),之前的疊圖整張偏 1.5 CSS px(結論是相對比較,不受影響)。校正後頂列 0 差、其餘元素高 1 個 2× 像素(0.5 CSS),把頂列以外元素下移 0.5 補回;方法寫進 design-spec。',
