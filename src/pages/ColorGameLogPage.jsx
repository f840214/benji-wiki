...
const ENTRIES = [
  {
    ...
    todo: ['大廳剩餘：區塊 B（遊戲標題 + 活動中心／Color War 入口，走 campaigns registry）、活動中心 News 落點（跑馬燈／banner 共用）、桌名語言表、桌台大賽人數、免費投注狀態、大廳視訊校正常數實機校、20:9 / 21:9 背景各匯一幀、頁尾寬框內部尺寸、新手教學觸發、GameLobby elog、廣告彈窗稿、SRE 填快照／廣告設定。'],
