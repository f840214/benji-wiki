...
const ENTRIES = [
  {
    ...
    files: ['src/views/components/RoadStrip.tsx', 'src/views/lobby/LobbyBackdrop.tsx', 'src/views/lobby/LobbyHeader.tsx', 'public/assets/lobby/header_ribbon_wide.svg', 'src/views/lobby/LobbyHeader.tsx', 'assets-raw/lobby/bg_curtain.png', 'public/assets/lobby/bg_curtain.webp', 'src/views/lobby/LobbyBackdrop.tsx', 'src/views/lobby/lobbyAssets.ts', 'src/views/lobby/lobbyAssets.test.ts'],
  },
  {
    date: '2026-09-14',
