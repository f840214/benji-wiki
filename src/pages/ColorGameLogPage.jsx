...
const STATE_INVENTORY = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'useTableSnapshot', path: 'src/game/hooks/useTableSnapshot.ts', role: '桌卡未播預覽時的快照網址：TRTC 快照 → video-replay → null（預設圖），Image 預載確認後才回；掛載與 refreshKey 變動時重抓，維護桌不抓。', writer: '—', reader: 'LobbyTableCard 縮圖區' },
