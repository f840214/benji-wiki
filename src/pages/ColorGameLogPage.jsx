...
const ENTRIES = [
  {
    ...
    files: ['src/views/lobby/LobbyStripText.tsx', 'src/views/lobby/LobbyTableCard.tsx', 'src/index.css', 'src/main.tsx', 'src/views/lobby/LobbyHeader.tsx', 'src/views/lobby/lobbyAssets.ts', 'public/assets/lobby/card/badge_room_id_bonus.svg'],
  },
  {
    date: '2026-09-11',
